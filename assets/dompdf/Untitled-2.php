        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="../sekar/cabs.php">


              <div class="form-group">
                   <label>Pilih Agenda Meeting Sesuai Jadwal</label> 
                   <select class="select2" name="id_online" data-placeholder="Pilih agenda Meeting" style="width: 100%;"required> 
                   <?php
                        $no = 0;
                        $query = mysqli_query($koneksi1, "SELECT * FROM absen RIGHT JOIN not_dir ON absen.id=not_dir.id_online");
                        while($row = mysqli_fetch_assoc($query)){
                          $no++;
                        echo "<option value='$row[id_online]'>".$row['agenda']." | ".$row['tanggal']."</option>";
                      } ?>   
                   </select>
                   </div>
              ...
              <div class="form-group">
                   ...
                   <option value=""></option>
						        <option value="Rapat Bisnis">Rapat Bisnis</option>
                    <option value="Rapat Direksi">Rapat Direksi</option>
                    <option value="Rapat Penyelesaian Kredit Bermasalah Per Cabang">Rapat Penyelesaian Kredit Bermasalah Per Cabang</option>
                    <option value="Rapat Kerja">Rapat Kerja</option>
                    <option value="Rapat Kredit">Rapat Kredit</option>
                    <option value="Rapat Pra Raker">Rapat Pra Raker</option>    
                   </select> 
                   </div>
