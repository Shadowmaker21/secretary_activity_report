...
$no=0;
$query = mysqli_query($koneksi1, "SELECT * FROM not_dir WHERE id_online='$id_online'");
...
$query = mysqli_query($koneksi1, "SELECT * FROM absen WHERE id_online='$id_online'");
...
$dompdf->render();
ob_clean();
$dompdf->stream("AbsenOnline '$thn'.pdf", array("Attachment"=>false));
?>
