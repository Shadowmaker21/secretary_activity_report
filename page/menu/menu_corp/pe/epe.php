<?php
    ...
    move_uploaded_file($file_tmp,"../files/".$spb_pe);
    ...
    $query=mysqli_query($koneksi1, "UPDATE pengurus_eksekutif SET nama_pe='$nama_pe' , ktp_pe='$ktp_pe', jabatan_pe='$jabatan_pe', awal_pe='$awal_pe', mjb_pe='$mjb_pe', spb_pe='$newname', spo_pe='$spo_pe', certif_pe='$newname1', jatem_pe='$jatem_pe' WHERE id = '$id'");
