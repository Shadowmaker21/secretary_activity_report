            ...
            <div class="card">
              ...
              <div class="table-responsive">
                <table id="examplebaru" class="table table-bordered table-striped">  
                    ...
                    <?php
                        $no = 0;
                        $query = mysqli_query($koneksi1, "SELECT id_offline, hari,tanggal,tempat,jam,agenda,ket,jenis,not_dekom.id_offline FROM not_dekom");
                      ...
                      <tr>
                        ...
                        <td>http://192.168.0.4/sekar/page_absen_offline.php?id_offline=<?php echo $row['id_offline'] ?></td>
                        <td><a href="http://192.168.0.4/sekar/hasil.php?id_offline=<?php echo $row['id_offline'] ?>" target="_blank">CETAK</a></td>
                      </tr>

                      <!-- Modal form Tambah User -->
                      <div class="modal fade" id="modal-edit<?php echo $row['id_offline'] ?>">
            ...
            <div class="modal-body">
              <form role="form" method="POST" action="index.php?page=edekom" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['id_offline'] ?>">
