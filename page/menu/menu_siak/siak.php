                ...
                <tbody>
                    <?php
                        ...
                        $query =   mysqli_query($koneksi1,"SELECT * FROM surat 
							...
							WHERE surat_status.status_direktur='Disetujui' and (surat_status.status_siak='Baru' or surat_status.status_siak IS NULL) ");
					...
					<?php }?>				
                            ...
                            <td>
                            <form action="index.php?page=accept2" method="POST" value="<?php echo $row['id']; ?>" enctype="multipart/form-data">
				<input type="hidden" name="appid2" value="<?php echo $row['id']; ?>">
                              <label>Upload Bukti Bayar Sanksi</label>
                            ...
                            <td>
					<?php 
					  if ($row['status_siak'] == NULL or $row['status_siak'] == "Baru") {
						echo "<div class='btn btn-warning btn-sm'>Disetujui Direksi. Order Bayar Sanksi !</div>";
					  }
					  else if ($row['status_siak'] == "Order Bayar Sanksi") {
						echo "<span class='badge badge-success'>Order Bayar Sanksi</span>";
					  }
				  ?>
							 		          </td>
